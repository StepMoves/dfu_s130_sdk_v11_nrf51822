...
#define ADVERTISING_LED_PIN_NO               LED_RED                                              /**< Is on when device is advertising. */
#define CONNECTED_LED_PIN_NO                 LED_BLUE                                               /**< Is on when device has connected. */
